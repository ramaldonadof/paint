...
export class PaintModule
{
  ...
  floodFill4(p, x, y, partX, partY, fillColor, color_O, color_A, parts)
  {
    ...
    if(element.color_A == color_O && x <= parts && y <= parts && x>0 && y>0)
    {
      ...
      aux = this.floodFill4 (p, x+1, y  , partX, partY, fillColor, color_O, color_A, parts);
      fillColor = aux_coor.exist(fillColor, element);
      aux = this.floodFill4 (p, x-1, y  , partX, partY, fillColor, color_O, color_A, parts);
      fillColor = aux_coor.exist(fillColor, element);
      aux = this.floodFill4 (p, x  , y+1, partX, partY, fillColor, color_O, color_A, parts);
      fillColor = aux_coor.exist(fillColor, element);
      aux = this.floodFill4 (p, x  , y-1, partX, partY, fillColor, color_O, color_A, parts);
      fillColor = aux_coor.exist(fillColor, element);
    }
